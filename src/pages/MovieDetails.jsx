...
export default function MovieDetails() {
        ...
        const loadProviders = async () => {
            try {
                const res = await fetch(
                    `https://api.themoviedb.org/3/movie/${id}/watch/providers?api_key=4e44d9029b1270a757cddc766a1bcb63`
                );
    ...
    const tmdbScore = details?.vote_average ? Math.round(details.vote_average * 10) : 0;
